...
describe('EventProjection', () => {
  describe('EventProjection creation', () => {
    describe('should expect ObjectStore object to have relevent methods', () => {
      ...
      it('should enforce have a getById method', ()=> {
        delete fakeObjectStore.getById;
        eventStoreCreate = () => createEventProjection('test', eventStore, fakeObjectStore);
        eventStoreCreate.should.throw(Error, /getById/);
      });

      it('should enforce have a set method', ()=> {
        delete fakeObjectStore.set;
        eventStoreCreate = () => createEventProjection('test', eventStore, fakeObjectStore);
        eventStoreCreate.should.throw(Error, /set/);
      });
    });
  });
